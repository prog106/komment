...
?>
                        <span class="label label-default">레벨<?=get_level($mem_point)?></span> <?=$mem_name?>
                    ...
                    <span style="font-size:11px;float:right;margin-right:20px;margin-top:5px;color:#555;"><?=after_datetime($create_at)?></span>
                    <h6 class="media-heading" style="line-height:14px;"><?=convert_text($answer)?></h6>
...
?>
                ...
                <hr style="margin-top:5px;margin-bottom:0px;border-top:1px solid #ddd;">
            </div>
